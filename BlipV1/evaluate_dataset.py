...
if __name__ == "__main__":
    config = {
        ...
        "caption_file": '/home/chris/Desktop/VLM/datasets/newsDataset/test_fixed.csv',
        # "caption_file": '/home/chris/Desktop/VLM/datasets/newsDataset/test_8k.csv',
        # "image_root": '/home/chris/Desktop/VLM/datasets/coco_train/images',
        # "caption_file": '/home/chris/Desktop/VLM/datasets/coco_train/test.csv',
        "image_size": 128,
        "prompt": ''
    }
    # pretrained_path = 'saveModels/Blipv1_flickr30k_19_20.pth'
    pretrained_path = '/home/chris/Desktop/VLM/BlipV1/record/newsDatasetV2_scratch_30/model.pth'
    # pretrained_path = '/home/chris/Desktop/VLM/BlipV1/record/newsDatasetV2_scratch_40/model.pth'
    # pretrained_path = '/home/chris/Desktop/VLM/BlipV1/record/newsDatasetV2_scratch_50/model.pth'
    # pretrained_path = '/home/chris/Desktop/VLM/BlipV1/record/newsDatasetV2_50/model.pth'
    # pretrained_path = '/home/chris/Desktop/VLM/BlipV1/record/CocoV2_pretrain_50/model.pth'
    # pretrained_path = '/home/chris/Desktop/VLM/BlipV1/record/flickr30kV2_pretrain_50/model.pth'
    # pretrained_path = '/home/chris/Desktop/VLM/BlipV1/record/newsDatasetV0_blip_large/model.pth'
    ...
    eval_dataset = Evaluate_dataset(transform_test, image_root, caption_file, max_words=30, prompt='')
    ...
    # bleu_scores, _ = bleu_scorer.compute_score(reference, candidate)
    # print(f"CIDEr Score: {cider_score}")
    # print(f"SPICE Score: {spice_score}")
    # print(f"BLEU Score: {bleu_scores[3]}")
    # print("BLEU-1..4:", bleu_scores)


    #### my model ####
    model = blip_decoder(pretrained=pretrained_path, image_size=config['image_size'], vit='base')
    model.eval()
